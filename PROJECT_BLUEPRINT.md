...
|------|--------|------|------|----------|----------|----------|
| PEND-01a04b8c-50ff-7c4a-a642-25782ac4849a | P1 | 用户提出 | AI 精确设计契约与工作包收口 | [端到端收口 WP-03](docs/design/2026-08-29_AI精确设计契约与工作包收口.md#wp-03-epic-closure) | 无 | 新设计只有一份可执行语义，能力工作包在实施中不漂移，多包需求由唯一收口包通过端到端组合验收 |
