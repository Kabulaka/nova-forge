...
| PEND-01a04338-4b0a-7d62-9808-e2ffe3ac409f | P1 | 用户提出 | Nova 文档资源按需加载与去重 | [资源加载 WP-01](docs/design/2026-08-27_Nova文档资源按需加载与去重.md#wp-01-document-resource-loading) | 无 | 已有文档体系的项目不加载跨业务完整示例，演进来源只读取必要元数据和存在冲突的定向契约，同一稳定资源不重复读取，且第三方插件与宿主展示保持未修改 |
