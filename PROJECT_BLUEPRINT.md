...
| PEND-007 | P1 | 用户提出 | Context-mode 可选路由治理 | [可选路由 WP-01](docs/design/2026-08-27_Context-mode可选路由治理.md#wp-01-context-mode-routing) | 无 | 安装与未安装 context-mode 的会话均可按输出规模安全路由，且不修改插件或绕过权限边界 |
