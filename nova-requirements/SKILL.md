...
显式引用成熟平台、标准、最佳实践、产品或仓库，或委托安全、身份、公共契约等高风险事项时，完整读取 [外部参考研究 SOP](../nova-development/references/reference-research-sop.md)。产品名仅作为研究例子时不得形成产品专属需求；普通低风险内部实现不在需求阶段展开。
