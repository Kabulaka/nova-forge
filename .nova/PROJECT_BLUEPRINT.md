...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a05bb2-de06-772b-aa7a-8fd2aced7911 | P1 | 用户提出 | Nova 访谈委托决策与参考研究共享契约 | [共享契约架构](design/2026-09-01_Nova访谈委托决策与参考研究闭环.md#wp-01-interview-governance-architecture) | 无 | 蓝图、共享工程骨架和访谈决策状态契约完成并通过校验，公共 API、事件和 Mock 明确不适用 | REQ-01a05ba8-f944-7de8-83ba-599a04745d83@v1 |
