...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a065b2-a963-7d1a-84e3-3898fba6b1bf | P0 | 用户提出 | 三阶段访谈差量投影实现 | [阶段差量投影实现 WP-01](design/2026-09-03_三阶段访谈差量投影实现.md#wp-01-stage-delta-projection-implementation) | 无 | 三阶段明确展示继承契约、本阶段事实、新增候选、未决差量及零差量依据，冲突时返回来源阶段并只重建受影响投影 | REQ-01a05ba8-f944-7de8-83ba-599a04745d83@v2 |
