...
| PEND-01a06615-f351-7c1b-996f-875631601546 | P1 | 问题诊断 | 合并集成契约闭环 | [合并集成契约闭环 WP-01](design/2026-09-03_合并集成契约闭环.md#wp-01-integration-contract-closure) | 无 | 检查点可无损恢复阶段投影，插件与兼容入口可互斥迁移并安全回退 | 无 |
| PEND-01a06626-fe17-7569-b31b-303218cc9c3b | P1 | Review-Defer | 版本化插件入口迁移与真实宿主闭环 | 待澄清 | 待澄清 | 插件实现后可原子迁移兼容链接，并在双宿主完成启用、禁用、卸载、故障回退和新会话 E2E | REQ-01a06524-60ee-7d61-a9f1-c588cd2bfdff@v1 |
