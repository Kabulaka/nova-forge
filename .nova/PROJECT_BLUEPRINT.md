...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a05c55-3b55-7a92-9684-aaaa643c1f1e | P1 | 用户提出 | 共享能力发现、目录与分层治理 | [共享能力发现与分层治理 WP-01](design/2026-09-01_Nova共享能力发现与分层治理.md#wp-01-shared-capability-governance) | 无 | 开发能发现并复用已有能力、由用户决定新抽象，且所有实现与目录登记服从蓝图分层并通过确定性校验 | 无 |
