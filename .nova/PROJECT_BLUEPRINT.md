...
| PEND-01a06a50-27d0-7fe5-8d30-ab9de658eaa0 | P0 | 用户提出 | 需求检查点提交机制 | 待澄清 | 无 | 确认需求可立即形成独立 requirement commit，下游校验精确绑定且 Review 不选择该提交 | REQ-01a06a50-2732-704d-97d0-7a98b205a4ea@v1 |
| PEND-01a06a50-281a-74ce-97a5-74e0385625e7 | P0 | 用户提出 | 完整交付台账与需求状态聚合 | 待澄清 | 无 | 首片前完整登记切片；单片 PASS 只更新进度，全部有效切片 PASS 后需求才已实现 | REQ-01a06a50-2732-704d-97d0-7a98b205a4ea@v1 |
