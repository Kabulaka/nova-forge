...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a05bd1-fddc-7f00-8390-36000c2942a7 | P1 | 用户提出 | Nova 访谈委托决策与参考研究实施 | [访谈委托决策实现](design/2026-09-01_Nova访谈委托决策与参考研究实施.md#wp-01-interview-delegation-implementation) | 无 | 三阶段入口、统一访谈和外部研究 SOP 依约实现并通过契约测试，且不包含产品专属规则或宿主持久化 | REQ-01a05ba8-f944-7de8-83ba-599a04745d83@v1 |
