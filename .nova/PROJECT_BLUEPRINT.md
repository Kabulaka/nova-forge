...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a05cbd-7146-77b9-98d8-954c24849ad6 | P1 | 用户提出 | Nova 当前项目健康检查 | [Nova 当前项目健康检查 WP-01](design/2026-09-01_Nova当前项目健康检查.md#wp-01-current-project-health-check) | 无 | 一次只读执行检查当前项目的 Nova 数据、引用、审计与迁移状态，输出稳定的 `PASS / WARN / FAIL` 且不改变项目 | 无 |
