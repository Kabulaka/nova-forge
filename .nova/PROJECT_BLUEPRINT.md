...
|------|--------|------|------|----------|----------|----------|----------|
| PEND-01a05c69-4c01-752c-835f-9070df93e6b3 | P1 | 用户提出 | 访谈范围与参考决策收敛 | [访谈范围与参考决策收敛 WP-01](design/2026-09-01_访谈范围与参考决策收敛.md#wp-01-interview-scope-reference-convergence) | 无 | 总体需求先锁定交付层级，成熟实践按证据形成可确认方案，明确参考功能研究后只澄清剩余差量 | 无 |
